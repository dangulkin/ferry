...
import { CaretRight, Sun, Moon, Plus, Bell, CalendarBlank, Wrench, ClockCounterClockwise, Archive, Globe, Info, EnvelopeSimple, FileText } from '@phosphor-icons/react';
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6 space-y-8">
        ...
        <section>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <SettingsItem icon={<Sun size={20} />} label="Morning" value="7:00 — 8:30" />
            <div className="h-px bg-gray-100 ml-12" />
            <SettingsItem icon={<Moon size={20} />} label="Evening" value="18:30 — 20:00" />
            <div className="h-px bg-gray-100 ml-12" />
        ...
        <section>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <SettingsItem icon={<Bell size={20} />} label="Notify me" value="15 min" />
            <div className="h-px bg-gray-100 ml-12" />
            <SettingsItem icon={<CalendarBlank size={20} />} label="Days" value="Mon, Tue, Wen, Thu, Fri" />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <SettingsItem icon={<Globe size={20} />} label="Language" value="EN" />
            <div className="h-px bg-gray-100 ml-12" />
            <SettingsItem icon={<Info size={20} />} label="About the service" />
            <div className="h-px bg-gray-100 ml-12" />
            <SettingsItem icon={<EnvelopeSimple size={20} />} label="Contact support" />
            <div className="h-px bg-gray-100 ml-12" />
            <SettingsItem icon={<FileText size={20} />} label="Terms & privacy" />
          </div>
        </section>
