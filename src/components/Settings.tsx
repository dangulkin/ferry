...
import { CaretRight, Sun, Moon, Plus, Bell, CalendarBlank, Wrench, ClockCounterClockwise, Archive, Globe, Info, EnvelopeSimple, FileText, WrenchIcon, ClockCounterClockwiseIcon, ArchiveIcon, GlobeIcon, InfoIcon, EnvelopeSimpleIcon, FileTextIcon, SunIcon, MoonIcon, BellIcon, CalendarBlankIcon, PlusIcon, CaretRightIcon } from '@phosphor-icons/react';
			...
			<div className="flex-1 overflow-y-auto px-4 pb-6 space-y-8">
				...
				<section>
					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
						<SettingsItem icon={<SunIcon size={20} weight="regular" />} label="Morning" value="7:00 — 8:30" />
						<div className="h-px bg-gray-100 ml-12" />
						<SettingsItem icon={<MoonIcon size={20} weight="regular" />} label="Evening" value="18:30 — 20:00" />
						<div className="h-px bg-gray-100 ml-12" />
						<button className="w-full flex items-center justify-between px-4 py-3.5 hover:bg-gray-50 transition-colors">
							...
							<CaretRightIcon size={16} className="text-sky-600" />
						</button>
					</div>
				</section>
				...
				<section>
					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
						<SettingsItem icon={<BellIcon size={20} weight="regular" />} label="Notify me" value="15 min" />
						<div className="h-px bg-gray-100 ml-12" />
						<SettingsItem icon={<CalendarBlankIcon size={20} weight="regular" />} label="Days" value="Mon, Tue, Wen, Thu, Fri" />
					</div>
				</section>
					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
						<div className="flex items-center justify-between px-4 py-3.5">
							<div className="flex items-center gap-3 text-gray-900">
								<WrenchIcon size={20} weight="regular" className="text-gray-500" />
						...
						<div className="flex items-center justify-between px-4 py-3.5">
							<div className="flex items-center gap-3 text-gray-900">
								<ClockCounterClockwiseIcon size={20} weight="regular" className="text-gray-500" />
						...
						<div className="px-4 py-4">
							<div className="flex items-center gap-3 text-gray-900 mb-3">
								<ArchiveIcon size={20} weight="regular" className="text-gray-500" />
				...
				<section>
					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
						<SettingsItem icon={<GlobeIcon size={20} weight="regular" />} label="Language" value="EN" />
						<div className="h-px bg-gray-100 ml-12" />
						<SettingsItem icon={<InfoIcon size={20} weight="regular" />} label="About the service" />
						<div className="h-px bg-gray-100 ml-12" />
						<SettingsItem icon={<EnvelopeSimpleIcon size={20} weight="regular" />} label="Contact support" />
						<div className="h-px bg-gray-100 ml-12" />
						<SettingsItem icon={<FileTextIcon size={20} weight="regular" />} label="Terms & privacy" />
					</div>
				</section>
